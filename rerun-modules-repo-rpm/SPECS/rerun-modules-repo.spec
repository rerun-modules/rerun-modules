Summary: Rerun Modules Yum repositories
...
%description
Yum definitions for repositories of Rerun modules maintained at GitHub (https://github.com/rerun-modules)
...
%files
%defattr(-,root,root)
/etc/yum.repos.d/rerun-modules.repo
